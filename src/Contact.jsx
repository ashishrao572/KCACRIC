...
<div className="contact-container">
  ...
  <div className="office-grid">
    <div className="contact-info">
      <h2>Head Office</h2>
      <p><strong>KCA Cricket</strong></p>
      <p>FF-102, Blue Ocean, Visat-Koba Road, Gandhinagar, Gujarat, India - 382421</p>
      <p><strong>Email: </strong><a href="mailto:contact@kcacric.com">hq@kcacric.com</a></p>
    ...
    <div className="contact-info">
      ...
      <p><strong>Email: </strong><a href="mailto:branch@kcacric.com">mysuru@kcacric.com</a></p>
    ...
    <div className="contact-info">
      ...
      <p><strong>Email: </strong><a href="mailto:branch@kcacric.com">edmonton@kcacric.com</a></p>
    ...
    <div className="contact-info">
      ...
      <p><strong>Email: </strong><a href="mailto:branch@kcacric.com">nyc@kcacric.com</a></p>
